...
def render():
    ...
    if dt > 218: # 218 is the final frame to render T2                     
        ...
        if (dt-218)%5 == 0: # update text per 3 frame
            s3_letter_index +=1
...
def show_banner():
    document['special_banner'].style.display = 'block'
    document['work'].style.animation = 'maskin 0.8s steps(29) forwards'
    document['work'].style['-webkit-animation'] = 'maskin 0.8s steps(29) forwards'
...
if window.innerWidth > 768:
    ...
    #randomly assign 5 groups for  random timing transition        
    for e in document.select('div.anim_letter'):
    ...
    document['mobile_region']<=html.P('2020秋季臺北觀鳥大賽', style={'font-size':'8vw','text-align':'center'})
    document['mobile_region']<=html.P('AUTUMN CHALLENGE', style={'font-size':'8vw', 'color':'#607B49','text-align':'center'})
    document['special_banner'].style = {'padding':'5vh 0 0 5%','display':'block','width':'90%','height':'auto','position':'relative'}
    document['mobile_region']<=document['special_banner']    
    document['special_banner'].style.display = 'block'
    document['work'].style.animation = 'maskin 0.8s steps(29) forwards'
    document['work'].style['-webkit-animation'] = 'maskin 0.8s steps(29) forwards'
    # position
